                ...
                <section class="text-gray-600 body-font relative">
                    <div class="container px-5 mx-auto">
                        ...
                        <div class="-m-2">
                            ...
                            <button onclick="location.href='{{ route('admin.owners.index')}}'" class="flex mx-auto bg-gray-200 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">戻る</button>
